...
<style>
  table.aud { border-collapse: collapse; width: 100%; }
  table.aud th, table.aud td { border: 1px solid #ddd; padding: 8px; vertical-align: top; }
  table.aud th { background: #f6f6f6; }
  table.aud audio { width: 220px; }
</style>
